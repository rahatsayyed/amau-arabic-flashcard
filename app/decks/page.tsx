  ...
  return (
    <>
      <header className="flex items-center justify-between px-gutter h-16 bg-primary-container text-on-primary">
        <span className="font-headline-lg-mobile text-headline-lg-mobile">Decks</span>
      </header>
      ...
      <div className="px-container-margin pb-md">
        ...
        <div className="-mt-8 mb-md grid grid-cols-2 gap-gutter relative z-10">
          ...
          <Link
            href="/decks/new"
            className="pressable-btn flex items-center justify-center gap-2 bg-secondary text-on-secondary py-3 px-4 rounded-xl font-label-md text-label-md shadow-md"
          >
        ...
        <div className="mt-lg">
          <div className="flex items-center justify-between mb-sm">
            ...
            <span className="font-label-md text-label-md text-on-surface-variant">{totalDecks} decks</span>
          </div>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <h4 className="font-title-md text-[16px] leading-tight text-primary line-clamp-2">{deck.title}</h4>
            ...
            {customDecks.map(deck => {
              ...
              return (
                ...
                >
                  <div>
                    <div className="w-10 h-10 bg-surface-container-high rounded-lg flex items-center justify-center mb-sm">
                      <span className="material-symbols-outlined text-primary">{deck.icon}</span>
                    </div>
                    <h4 className="font-title-md text-[16px] leading-tight text-primary line-clamp-2">{deck.title}</h4>
                    <p className="font-label-md text-[12px] text-on-surface-variant mt-1">{deck.cards.length} Cards</p>
                  </div>
